...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Ork', 'ork'), ('Elf', 'elf'), ('Dwarf', 'dwarf'), ('Human', 'human')], max_length=255, unique=True)),
                ('description', models.TextField(blank=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(blank=True, verbose_name='It stores a short description provided by a user about himself/herself.')),
